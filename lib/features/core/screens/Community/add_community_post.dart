...
import 'package:hps/common/convert_assets_image_to_file.dart';
import 'package:hps/common/custom_toast_message.dart';
import 'package:hps/common/image_compress.dart';
        ...
        child: ListView(
          ...
          children: [
            ...
            Obx(
              () => ElevatedButton(
                child:
                    communtiyController.communityIsLoading.value
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    communtiyController.listOfCommunityPost.insert(
                      0,
                      communityPostJson,
                    );
