...
import 'package:hps/features/personalization/screens/settings/widgets/indivitual_user_post.dart';
...
class settingsController extends GetxController {
    ...
    for (var marker in markers) {
      ...
      File? image =
          imageFile.existsSync()
              ? imageFile
              : await MarkerMapController.instance.getImageFile(
                imageUrl,
                marker["id"],
              );
  ...
  Future<void> updateNameInProfile(String nameValue) async {
    await firebaseQueryForProfile().updateProfileFieldsInProfile(
      "name",
      nameValue,
    );
