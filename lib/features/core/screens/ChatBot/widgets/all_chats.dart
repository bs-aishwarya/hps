...
import 'package:hps/features/core/screens/ChatBot/widgets/custom_msg.dart';
import 'package:hps/utils/constants/images_strings.dart';

class AllChats extends StatelessWidget {
  const AllChats({super.key, required this.chatController});
            ...
            () => Column(
              ...
              children: [
                ...
                for (int i = 0; i < chatController.msgList.value.length; i++)
                  Align(
                    alignment:
                        chatController.msgList.value[i][1] == "u"
                    ...
                    child: CustomMessage(
                      ...
                      mapIndex:
                          chatController.msgList.value[i][2] == "Now"
                              ? i
                              : null,
                    ),
                  ),
