...
class ChatBotController extends GetxController {
  ...
  RxList<List<String>> msgList =
      [
        [
          "Hello, my name is hps! I'm here to guide you. Is there anything particular you'd like to know about homelessness?",
          "c",
  ...
  Future<void> uploadAndGetResponseFromChatbot(String userMsg) async {
    try {
      var url = Uri.https('hpsbackend-vu6qon67ia-el.a.run.app', '/chat/send');
      ...
      if (response.statusCode == 200) {
        ...
        var formattedReply = MyAppFormatter.formatStringSpaces(
          jsonResponse['reply'],
        );
