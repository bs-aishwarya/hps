...
import 'package:hps/features/core/screens/home/widgets/custom_clipper.dart';
import 'package:hps/features/core/screens/home/widgets/half_map_search_button.dart';
import 'package:hps/features/core/screens/home/widgets/move_to_makrer_screen_button.dart';
import 'package:hps/features/core/screens/home/widgets/sos_button.dart';
...
class HomeHeaderMapWithButtons extends StatelessWidget {
  HomeHeaderMapWithButtons({super.key, required this.halfMapController});
  ...
  Widget build(BuildContext context) {
    DefaultAssetBundle.of(
      context,
    ).loadString("assets/map_style/aubergine.json").then((value) {
      mapTheme = value;
    });
    return Stack(
      children: [
