...
class searchBar extends StatelessWidget {
  const searchBar({super.key, required this.markerMapController});
  ...
  void searchBarTapFunction(int index) async {
    ...
    try {
      await markerMapController.googleMapController.animateCamera(
        CameraUpdate.newLatLngZoom(searchPosition, 16),
      );
