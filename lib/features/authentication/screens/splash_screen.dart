...
import 'package:hps/bottom_nav_bar.dart';
import 'package:hps/features/authentication/screens/login/login_screen.dart';
import 'package:hps/features/authentication/screens/on_board/onBoarding.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: MyAppHelperFunctions.screenHeight() / 2 - 170),
          Center(
