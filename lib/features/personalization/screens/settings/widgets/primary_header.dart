...
import 'package:hps/data/repositories/firebase_query_for_profile/firebase_query_for_profile.dart';
...
class PrimaryHeader extends StatelessWidget {
        ...
        children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  colors: [Color.fromARGB(0, 7, 112, 82), Color(0xFF00D47E)],
          ...
          Positioned(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              leading: const Icon(Iconsax.setting, color: Colors.white),
            ),
          ),
                    ...
                    await firebaseQueryForProfile()
                        ...
                        .onError(
                          (error, stackTrace) => showCustomToast(
                            ...
                            text: "Error Uploding Image in Database: $error",
  ...
  Future<void> addNewCustomMarkerInMapScreens(File image) async {
    final marker = Marker(
      ...
      icon: await CircularWidget(imageFile: image).toBitmapDescriptor(
