...
class HomeStatsRatingController extends GetxController {
  ...
  Future<void> crimeIncidentsMarker() async {
    try {
      ...
      CollectionReference sosCollection = FirebaseFirestore.instance.collection(
        'SOS_Reports',
      );
  ...
  Future<void> homelessSightingsMarker() async {
    try {
      ...
      // Reference to the 'Markers' collection
      CollectionReference markersCollection = FirebaseFirestore.instance
          .collection('Markers');
      ...
      for (QueryDocumentSnapshot document in querySnapshot.docs) {
        ...
        await imageFile
            ...
            .then(
              (value) =>
                  debugPrint("Image File Homeless Sightings: $imageFile"),
            );
