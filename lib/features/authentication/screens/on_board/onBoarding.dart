...
import 'package:hps/features/authentication/controllers/onBoarding_controller.dart';
import 'package:hps/features/authentication/screens/on_board/widgets/onBoard_page.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: PageView(
              ...
              children: const [
                onBoardPage(
                  title: 'Welcome To hps',
                  subTitle:
                      "hps means Helping Everyone in Struggle Through Innovative Assistance. Our mission is to provide help to homeless people by involving our community.",
