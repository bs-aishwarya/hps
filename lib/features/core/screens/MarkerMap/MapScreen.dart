...
import 'package:hps/features/core/screens/MarkerMap/widgets/Floating_Buttons_Mark_map_Screen.dart';
import 'package:hps/features/core/screens/MarkerMap/widgets/search_bar.dart';
                      ...
                      () => GoogleMap(
                        onMapCreated: (controller) async {
                          ...
                          if (MyAppHelperFunctions.isNightTime()) {
                            markerMapController.googleMapController.setMapStyle(
                              mapTheme,
                            );
                          }
                          markerMapController
                        ...
                        onTap: (latLng) {
                          markerMapController
                              ...
                              .value
                              .hideInfoWindow!();
                          if (markerMapController.IsInfoWindowOpen.value ==
                                  false &&
                          ...
                          markerMapController.changeValueOfInfoWindowOpen(
                            false,
                          );
                          markerMapController.isSearchBarVisible.value =
