...
import 'package:hps/common/common_values.dart';
import 'package:hps/common/custom_toast_message.dart';
import 'package:hps/common/time_format.dart';
import 'package:hps/common/widgets/buttons/elevated_button_with_icon.dart';
import 'package:hps/common/widgets/buttons/swipe_button_view/swipeable_button.dart';
...
import 'package:hps/features/core/screens/Community/add_community_post.dart';
import 'package:hps/features/core/screens/MarkerMap/MapScreen.dart';
...
class CustomUserCommentTextField extends StatelessWidget {
  const CustomUserCommentTextField({
    super.key,
    required this.postId,
...
Future<File> _writeTempFile(List<int> bytes) async {
  ...
  File tempFile = File('${tempDir.path}/hps Community.png');
