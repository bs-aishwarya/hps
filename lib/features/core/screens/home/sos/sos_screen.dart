...
import 'package:hps/features/core/controllers/sos_mini_map_controller.dart';
import 'package:hps/features/core/screens/home/sos/widgets/form_submit_button.dart';
import 'package:hps/features/core/screens/home/sos/widgets/incident_address.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Text("SOS", style: Theme.of(context).textTheme.headlineSmall),
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                SizedBox(height: MyAppHelperFunctions.screenHeight() * 0.02),
                ...
                DropdownButtonFormField(
                  ...
                  items:
                      CommonValues.categories.map((String category) {
