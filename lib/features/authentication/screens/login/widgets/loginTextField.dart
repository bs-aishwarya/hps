...
import 'package:hps/utils/validators/validation.dart';
import 'package:iconsax/iconsax.dart';

// ignore: must_be_immutable
class LoginTextField extends StatelessWidget {
  LoginTextField({super.key, required this.email, required this.password});
          ...
          () => TextFormField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                icon:
                    LoginController.instance.loginObscureText.value
